    ...
    <Suspense fallback="loading">
      <Box sx={{ align: 'center', px: '20%' }}>
        ...
        >
          ...
          <Box>
            <Typography variant="h2">{t('molele')}</Typography>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Typography
                  ...
                  sx={{ maxWidth: 300 }}
                >
                  The AiMat (Artificial Intelligence for Materials sciences)
                  group of KIT develops AI and machine learning solutions for
                  the materials sciences and is the client for this web
                  application.
                </Typography>
              </CardContent>
              <CardActions>
